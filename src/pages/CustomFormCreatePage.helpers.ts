...
export const CANVAS_ID = "custom-form-canvas";
...
export const CONTROL_ICON_MAP: Record<string, LucideIcon> = {
  text: Type,
  email: Mail,
  number: Hash,
  date: CalendarDays,
...
export function parseDelimitedDefaultValues(value: string | null | undefined) {
  return Array.from(
    new Set(
      (value ?? "")
        .split(",")
...
export function getSelectedOptionValues(field: CustomFormFieldDraft) {
...
export function buildEmptyDraft(): CustomFormDraft {
  return {
    name: "",
    headerText: "",
    description: "",
...
export function buildPreviewValues(fields: CustomFormFieldDraft[]) {
