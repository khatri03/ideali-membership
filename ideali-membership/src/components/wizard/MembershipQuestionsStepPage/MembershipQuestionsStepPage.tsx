...
import { constrainSelectedFormDragToParent } from "./MembershipQuestionsStepPage.helpers";
import {
...
} from "./MembershipQuestionsStepPage.parts";
...
export function MembershipQuestionsStepPage() {
  ...
  function onSelectedFormsDragEnd(event: DragEndEvent) {
    ...
    arrayMove(selectedCustomFormUniqueIds, oldIndex, newIndex);
